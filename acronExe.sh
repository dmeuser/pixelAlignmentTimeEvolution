#!/bin/bash
# acrontab -e
# enter: 0 6 * * * lxplus.cern.ch /afs/cern.ch/user/a/auterman/alignment2018/pixelAlignmentTimeEvolution/acronExe.sh

logFile=/afs/cern.ch/user/a/auterman/alignment2018/pixelAlignmentTimeEvolution/acron.log
echo >> $logFile 2>&1
date >> $logFile 2>&1
...
cd /afs/cern.ch/user/a/auterman/alignment2018/pixelAlignmentTimeEvolution >> $logFile 2>&1
